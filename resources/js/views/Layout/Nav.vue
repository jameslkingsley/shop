                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        <div class="ml-3 relative">
                            <div>
                                <button @click="profileDropdownVisible = ! profileDropdownVisible" class="max-w-xs flex items-center text-base font-medium px-4 py-1 rounded-full text-white focus:outline-none focus:shadow-solid transition-all duration-200 ease-in-out" id="user-menu" aria-label="User menu" aria-haspopup="true">
                                    James
                                </button>
                            </div>
                            <!--
                            ...
                            -->
                            <div v-show="profileDropdownVisible" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
