...
/* harmony default export */ __webpack_exports__["default"] = ({
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 5;
              return ajax.get("/api/product/".concat(to.params.group));

            case 5:
              products = _context.sent;
              next(function (vm) {
                return vm.fill(categories.data, products.data);
              });
  ...
  methods: {
    fill: function fill(categories, products) {
...
// module
exports.push([module.i, ".-ml-basket[data-v-81fbb27e] {\n  margin-left: -24rem;\n}", ""]);
    ...
    _c(
      ...
      [
        ...
        _c(
          ...
          {
            staticClass:
              "w-full bg-blue-500 text-white py-4 text-lg rounded-none",
            attrs: {
              disabled:
