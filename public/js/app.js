...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function has(productId) {
      return productId in this.store.items && this.store.items[productId].qty > 0;
    }
  }, {
    key: "clear",
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  off: function off(name, callback) {
    this.events[name] = this.events[name].filter(function (registerCallback) {
  ...
  emit: function emit(name) {
    ...
    window.dispatchEvent(new CustomEvent("spruce:".concat(name), {
      detail: data,
      bubbles: true
    }));
  },
  watch: function watch(dotNotation, callback) {
  ...
  runWatchers: function runWatchers(stores, target, key, oldValue) {
    var self = this;

    if (self.watchers[key]) {
      return self.watchers[key].forEach(function (callback) {
        return callback(oldValue, target[key]);
      });
    }

    Object.keys(self.watchers).filter(function (watcher) {
      return watcher.includes('.');
    }).forEach(function (fullDotNotationKey) {
      var dotNotationParts = fullDotNotationKey.split('.');
      if (key !== dotNotationParts[dotNotationParts.length - 1]) return;
      dotNotationParts.reduce(function (comparison, part) {
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./resources/js/spruce/utils.js");
/* harmony import */ var _observable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./observable */ "./resources/js/spruce/observable.js");
/* harmony import */ var _bus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bus */ "./resources/js/spruce/bus.js");
...
var Spruce = {
  ...
  events: _bus__WEBPACK_IMPORTED_MODULE_3__["default"],
  stores: {},
  subscribers: [],
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Object(_utils__WEBPACK_IMPORTED_MODULE_1__["domReady"])();

            case 2:
              _this.emit('init');

              document.addEventListener('turbolinks:render', _this.attach);

              _this.attach();

              _this.stores = Object(_observable__WEBPACK_IMPORTED_MODULE_2__["createObservable"])(_this.stores, {
                set: function set(target, key, value, oldValue) {
                  _this.events.runWatchers(_this.stores, target, key, oldValue);

                  _this.updateSubscribers();
                }
              });

              if (_this.options.globalStoreVariable) {
                document.querySelectorAll('[x-data]').forEach(function (el) {
                  if (!_this.subscribers.includes(el)) {
                    _this.subscribers.push(el);
                  }
                });
                window.$store = _this.stores;
              }
  ...
  attach: function attach() {
    document.querySelectorAll('[x-subscribe]').forEach(function (el) {
      el.setAttribute('x-init', Object(_utils__WEBPACK_IMPORTED_MODULE_1__["buildInitExpression"])(el));
      el.removeAttribute('x-subscribe');
    });
  },
  store: function store(name, state) {
    if (!this.stores[name]) {
  ...
  reset: function reset(name, state) {
    this.stores[name] = state;
  },
  ...
  updateSubscribers: function updateSubscribers() {
  ...
  emit: function emit(name) {
    var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    this.events.emit(name, _objectSpread(_objectSpread({}, data), {}, {
      store: this.stores
    }));
  },
  watch: function watch(dotNotation, callback) {
...
var deferrer = window.deferLoadingAlpine || function (callback) {
  callback();
};
...
/* harmony default export */ __webpack_exports__["default"] = (Spruce);

/***/ }),

/***/ "./resources/js/spruce/observable.js":
/*!*******************************************!*\
  !*** ./resources/js/spruce/observable.js ***!
  \*******************************************/
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./resources/js/spruce/utils.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }


var createObservable = function createObservable(target, callbacks) {
  Object.keys(target).forEach(function (key) {
    if (!Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isNullOrUndefined"])(target[key]) && Object.getPrototypeOf(target[key]) === Object.prototype) {
  ...
  return new Proxy(target, {
    ...
    set: function set(target, key, value) {
      ...
      if (!Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isNullOrUndefined"])(value) && _typeof(value) === 'object') {
...
/***/ "./resources/js/spruce/utils.js":
/*!**************************************!*\
  !*** ./resources/js/spruce/utils.js ***!
  \**************************************/
/*! exports provided: domReady, buildInitExpression, isNullOrUndefined */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "domReady", function() { return domReady; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildInitExpression", function() { return buildInitExpression; });
...
var buildInitExpression = function buildInitExpression(el) {
  var expression = "$store = Spruce.subscribe($el)";

  if (el.hasAttribute('x-init')) {
    expression = "".concat(expression, "; ").concat(el.getAttribute('x-init'));
  }
